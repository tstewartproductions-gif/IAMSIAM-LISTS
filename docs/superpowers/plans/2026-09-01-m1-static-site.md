...
.intro-strip{
  ...
  color:var(--strip);font-size:11px;letter-spacing:.08em;text-align:center;
}
...
.about p{color:var(--meta);margin-bottom:16px}
.about a{border-bottom:1px solid var(--strip)}

.site-foot{
  display:flex;justify-content:center;gap:18px;padding:20px 24px;border-top:1px solid var(--border);
